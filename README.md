...
<h2>Is Landon a good best friend?</h2>
    ...
    <div>
        <input type="radio"  name="answer" value="Of course" id="ofC">
        <label for="ofC">Of course</label>
    </div>
    <div>
        <input type="radio"  name="answer" value="Absolutely" id="abs">
        <label for="abs">Absolutely</label>
    </div>
    <div>
        <input type="radio"  name="answer" value="Without a doubt" id="wAD">
...
<h2>Is there anything you wish Landon did better?</h2>
    ...
    <div>
        <input type="radio"  name="answer" value="Not at all" id="nAA">
        <label for="nAA">Not at all</label>
    </div>
    <div>
        <input type="radio"  name="answer" value="He does everything perfectly" id="perf">
